...
![konigsberg-map](images/konigsberg-map.png)

![simple-konigsberg-map](images/simple-konigsberg-map.png)
...
![konigsberg-graph](images/konigsberg-graph.png)
...
![not-orient-graph](images/not-orient-graph.png)
...
![linked-graph](images/linked-graph.png)

* *несвязный* - в графе отсутствует путь хотя бы между двумя его вершинами

![not-linked-graph](images/not-linked-graph.png)
...
Пример задания графа с помощью матрицы смежности можно найти [тут](graph_examples.md) и [тут](dot_example_rus.md).
...
Реализовать библиотеку graph.h:
* Библиотека должна быть разработана на языке С++ стандарта C++20
* Код библиотеки должен находиться в папке src в ветке develop  
* При написании кода необходимо придерживаться Google Style
* Оформить решение как статическую библиотеку (с заголовочным файлом graph.h)
...
* Сборка программы должна быть настроена с помощью Makefile со стандартным набором целей для GNU-программ: _all, clean, test, graph.a
...
Реализовать библиотеку graph_algorithms.h
* Библиотека должна быть разработана на языке С++ стандарта C++20
* Код библиотеки должен находиться в папке src в ветке develop  
* Оформить решение как статическую библиотеку (с заголовочным файлом graph_algorithms.h)
...
* Добавить в Makefile цель graph_algorithms.a
...
* Необходимо использовать *самописные* вспомогательные классы `Stack` и `Queue` (для этого можно переиспользовать своё решение из библиотке контейнеров). Эти классы должны содержать в себе следующие методы:
